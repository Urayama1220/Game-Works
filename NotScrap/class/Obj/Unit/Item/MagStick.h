...
public:
    ...
    void Update(GimmickList& gimmicklist, EneymyList& enemyList, MagBoxList& list,Vector3 pos,Vector3 dir,State state,const CntData& cntdata, const EneymyList& enemy);
    //描画
...
private:
    ...
    //Ｓ極とＮ極の当たり判定
    void CheckMagnetColl(void);

    //磁石の箱との判定
    void CheckMagnetBox(GimmickList& gimmicklist);
    //転がるアクセサリ―との当たり判定
    void CheckAccessory(GimmickList& gimmicklist);
    //敵をくっつける処理
    void CheckStickEnemy(void);
