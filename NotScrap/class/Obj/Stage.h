...
struct PairObject {
	int path_;				//ファイル名1
	int path2_;				//ファイル名2
	string objectName_;		//オブジェクト名1
	string objectName2_;	//オブジェクト名2
	Vector3 pos_;			//座標1
	Vector3 pos2_;			//座標2
	Vector3 rotate_;		//回転1
	Vector3 rotate2_;		//回転2
	PairObject(int path,int path2,
	string name,string name2,
	Vector3& pos,Vector3& pos2,
	Vector3& rotate,Vector3& rotate2):
		path_(path),path2_(path2),
		objectName_(name),objectName2_(name2),
		pos_(pos),pos2_(pos2),
		rotate_(rotate),rotate2_(rotate2) {};
};
